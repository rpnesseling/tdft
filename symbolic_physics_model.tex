...
.. 2835 ^ 48 = 1
36080 per 1/48 orbit. 2 earth days is one sun (sol) day.
...
Conclusion
Sqrt problmen can be solved by using the Dimensional Algebra model used above.
F0 = F^1 F^2 F^3= F0 and finding the F0 value.
