...
\begin{itemize}
    \item A parent field hierarchical coupling (relativity chain)
    \item Force as value (as opposing//imposing Force)
    \item A maximum Force value or collapse threshold (in sets of 3^3)
...
\item A fast or flash reaction is essentially a perfect execution of going through all the stages. Growing non-linear in Force and chasing after parent's parent field. Always getting hotter in ever increasing steps. Suggests that all 'reactions' that produce heat are an example of the field collapse/expanse theory. Since forces do, including Time, Space and SpaceTime it's apparent that exicstence is a reaction in total.
